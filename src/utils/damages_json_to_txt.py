...
#import mapping file:
from classes import damage_mapper, parts_mapper

#put them together (join them):
everything_mapper = {**damage_mapper , **parts_mapper}

current_dir = os.getcwd()
print(f'launching script from directory: {current_dir}')

car_damages_ann_path = "data/Car damages dataset/File1/ann"

out_dir = "data/Car damages dataset/File1/labels" #where txt labels will go
